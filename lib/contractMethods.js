...
export const getPairInfo = async (address1, address2, userAddress) => {
  ...
  if (pairAddress == 0) return undefined;
  ...
  const correctOrder =
    poolToken1Address.toLowerCase() === address1.toLowerCase();
  let reserve1 = correctOrder ? reserves.reserve1 : reserves.reserve0;
  let reserve2 = correctOrder ? reserves.reserve0 : reserves.reserve1;
